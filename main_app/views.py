...
class FavoriteTreatList(LoginRequiredMixin, ListView):
    model = FavoriteTreat


class FavoriteTreatDetail(LoginRequiredMixin, DetailView):
    model = FavoriteTreat


class FavoriteTreatCreate(LoginRequiredMixin, CreateView):
    model = FavoriteTreat
    fields = '__all__'


class FavoriteTreatUpdate(LoginRequiredMixin, UpdateView):
    model = FavoriteTreat
    fields = ['name', 'flavor']


class FavoriteTreatDelete(LoginRequiredMixin, DeleteView):
    model = FavoriteTreat
    success_url = '/treats/'
